...
values
  ...
  ('monthly_payment', 'Monatliche Zahlung', 'Monthly payment'),
  ...
  ('save', 'Speichern', 'Save'),
  ('save_10_percent_with_yearly', 'Spare 10%!', 'Save 10%!'),
  ...
  ('yearly_exclusive_4', 'Kündbar zum Aboende', 'Cancellable at the end of the subscription'),
  ('yearly_payment', 'Jährliche Zahlung', 'Yearly payment'),
  ...
  ('yearly_premium_4', 'Kündbar zum Aboende', 'Cancellable at the end of the subscription'),
